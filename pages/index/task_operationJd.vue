		...
		<view v-show="(order.model==1&&isLoading)||(order.model==5&&isLoading)">
									...
									<view class="" style="background-color: #ececec;">
										<view class="is-list2-info has-list2-tip ">
									        <view class="" style="padding: 18rpx 24rpx;">
												...
												<view class="has-mgt-10 has-mgb-10 is-grey is-size-15">在当前关键词搜索下，找到<span style="font-weight: 900;color:#fe6248">目标商品</span>的同时随机点击2-3个相关的产品进行货比浏览,<span style="color:#fe6248">并在目标商品详情中找到以下问题的答案</span> <navigator url="/pages/detail/content?id=80" hover-class="navigator-hover">。<span class="is-blue">→点击查看示例</span></navigator></view>
												...
												<view class="has-mgt-10 has-mgb-10 is-grey is-size-15">在目标商品店铺，随机选择店铺几款产品进行浏览。<navigator url="/pages/detail/content?id=81" hover-class="navigator-hover"><span class="is-blue">→点击查看示例</span></navigator></view>
									        </view>
									    </view>
									</view>
								</view>
			...
			<view style="margin-top: 20rpx;" class="step-two" >
				...
				<view class="step-content" style="padding: 18rpx 24rpx;">
					...
					<navigator url="/pages/detail/content?id=82" hover-class="navigator-hover"><view style="color:#FF6600;font-size: 28rpx;">点击查看示例>>></view></navigator>
					<!-- 图片上传 -->
			...
			<view style="margin-top: 20rpx;" >
				...
				<view class="step-content" style="padding: 18rpx 24rpx;">
					...
					<view>
						<navigator url="/pages/detail/content?id=83" hover-class="navigator-hover" ><view style="color:#FF6600">点击查看示例>>></view></navigator>
					</view>
			...
			loadData:function(){//加载详情数据
				...
				this.$Request("task/getinfo",{order_sn:this.order_sn,uid:this.userid}).then(res=>{
					if (res.code == 200 ) {
						...
						// for(let i=0;i<product.addtional_info.additional_money.length;i++){
						// 	console.log(product.addtional_info.additional_money[i]);
						// 	var obj = {
