                ...
                <view class="is-item2 is-a">
                    ...
                    <view class="is-list2-info has-bordert" style="padding-right: 20rpx;justify-content: space-between;">
                       ...
                       <view >
                       	...
                       	<view style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;">
                       		<view class="">
                       			<span style="color: #9C9D9F;font-size: 24rpx;">无需垫资</span>
                       		</view>
	...
	export default {
		...
		methods:{
			...
			toDetail:function(order_sn){
				uni.navigateTo({url:'/pages/index/new_detailPinDuoDuo?order_sn='+order_sn}); 
			}
		}
	}
</script>
