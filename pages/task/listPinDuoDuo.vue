...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap:function(e){
			uni.navigateTo({url:'/pages/task/searchPinDuoDuo'})
		},
		...
		methods:{
			...
			loadData:function(hideload){
				...
				this.$Request("task/getTasklist",{status:this.status,uid:this.userid,page:this.page,model:this.model,platform:'pinduoduo'}).then(res=>{
