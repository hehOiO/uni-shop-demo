				...
				<view class="s-list ">
					...
					<view class="upload-img-container">
						<view>
							...
							<view class="upload-img-item-box" @tap="previewImage(buyerinfo.chat_pic)">
								<view class="upload-img-before-box">
									<image :src="buyerinfo.chat_pic" style="width: 100%;height: 100%;vertical-align:bottom;"></image>
								</view>
	...
	export default {
		...
		methods: {
			...
			previewImage(src) {
				...
				srclist[1] = this.buyerinfo.chat_pic;
				if (src) {
					uni.previewImage({
						current: src,
						urls: srclist,
			...
			editBuyer() {
				...
				uni.navigateTo({
					url: '/pages/ucenter/security/bindBuyerPinDuoDuo?mode=' + mode + "&itemid=" + itemid
				});
			}
		},
		onLoad: function(e) {
