<template>
	<view class="page">
		...
		<view class="has-bg-white">
			...
			<navigator url="/pages/detail/content?id=90" style="background-color: #8FC4D9;font-size: 30rpx;letter-spacing: 4rpx;" class="has-button-small">点击查看绑定要求</navigator>
		</view>
		<!-- 账号信息 -->
		...
		<view class="upload-img-container">
			...
			<view class="upload-img-item-box">
				<view class="upload-img-before-box" @tap="uploadPic1" v-if="sendData.chat_pic==''">
					<image src="../../../static/images/common/uploadImgPng.png" mode="widthFix"></image>
					<text>点击上传图片</text>
				</view>
				<view class="upload-img-before-box" @tap="showImages(sendData.chat_pic)" v-if="sendData.chat_pic!=''">
					<image style="width: 100%;height: 100%;vertical-align:bottom;" :src="sendData.chat_pic" mode="scaleToFill"></image>
					<image @tap="deleImg('chat_pic')" src="../../../static/images/task/clear.png" mode="widthFix" style="width: 40rpx;position:absolute;right: -25rpx;top: -25rpx;"></image>
				</view>
				<view class="upload-text-bottom">
					微信/QQ截图
				</view>
